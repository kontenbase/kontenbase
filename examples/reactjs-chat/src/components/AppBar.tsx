              ...
              <Menu.Button className="avatar-button">
                <div className="avatar-container">
                  ...
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.00002 11.3335C7.66269 11.3335 7.34002 11.1782 7.11602 10.9055L4.30735 7.50683C3.97135 7.0995 3.90402 6.5215 4.13468 6.03283C4.33802 5.6015 4.74269 5.3335 5.19135 5.3335H10.8087C11.2574 5.3335 11.662 5.6015 11.8654 6.03283C12.096 6.5215 12.0287 7.0995 11.6934 7.50616L8.88402 10.9055C8.66002 11.1782 8.33735 11.3335 8.00002 11.3335Z" fill="#38BF4B" />
                    <mask id="mask0_580_677" maskUnits="userSpaceOnUse" x="3" y="5" width="10" height="7">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M8.00002 11.3335C7.66269 11.3335 7.34002 11.1782 7.11602 10.9055L4.30735 7.50683C3.97135 7.0995 3.90402 6.5215 4.13468 6.03283C4.33802 5.6015 4.74269 5.3335 5.19135 5.3335H10.8087C11.2574 5.3335 11.662 5.6015 11.8654 6.03283C12.096 6.5215 12.0287 7.0995 11.6934 7.50616L8.88402 10.9055C8.66002 11.1782 8.33735 11.3335 8.00002 11.3335Z" fill="white" />
                    </mask>
                    <g mask="url(#mask0_580_677)">
                      <rect width="16" height="16" fill="#38BF4B" />
                    </g>
                  </svg>
                </div>
              </Menu.Button>
